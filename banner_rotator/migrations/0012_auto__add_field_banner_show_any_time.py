...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Banner.show_any_time'
        db.add_column('banner_rotator_banner', 'show_any_time', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Banner.show_any_time'
        db.delete_column('banner_rotator_banner', 'show_any_time')
    ...
    models = {
        ...
        'banner_rotator.banner': {
            ...
            'show_any_time': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'start_at': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'timeout': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
