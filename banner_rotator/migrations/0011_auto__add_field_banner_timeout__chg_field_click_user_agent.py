...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Banner.timeout'
        db.add_column('banner_rotator_banner', 'timeout', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Banner.timeout'
        db.delete_column('banner_rotator_banner', 'timeout')
